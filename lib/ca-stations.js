(function(){
	 ...
	 */
	{
		...
		{(stations.add(new Station('AAFC Site, Winchester  AWP', '02KF006'))
			.addTs(new TimeSeries('Precipitation', 'mm', 'PP', 0).setSource("38783042"), true)
		)};
		{(stations.add(new Station('Seguin Rd nesr CR138 AWP', '02KF006'))
			.addTs(new TimeSeries('Precipitation', 'mm', 'PP', 0).setSource("38790042"), true)
		)};
